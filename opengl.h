...
// Macro(PFNGLMEMORYBARRIERPROC, glMemoryBarrier) MemoryBarrier is already defined
#define SELECTED_OPENGL_FUNCTIONS(Macro) \
  ...
  Macro(PFNGLDRAWELEMENTSINSTANCEDBASEVERTEXBASEINSTANCEPROC, glDrawElementsInstancedBaseVertexBaseInstance) \
  ...
  Macro(PFNGLGETNAMEDFRAMEBUFFERATTACHMENTPARAMETERIVPROC, glGetNamedFramebufferAttachmentParameteriv) \
